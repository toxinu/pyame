...
def get_special_content_files():
	...
	special_files = {"welcome_message": "Here your welcome message, edit by creating a welcome_message file in your content folder.",
...
def run():
	...
	root_menu, sub_menu = menu.generate(GLOBAL_CONFIG.no_list_no_render,
										GLOBAL_CONFIG.no_list_yes_render,
										GLOBAL_CONFIG.extensions_to_render,
										GLOBAL_CONFIG.content_folder,
										special_files)
	browse_and_build_all(	GLOBAL_CONFIG.content_folder,
	...
	html_render_index = template.render(website_title	= GLOBAL_CONFIG.website_title,
